...
<html lang="fr">
  <head>
    ...
    <style> 
header {
background-image: url("img\\chikensatay.jpg");
height: 450px;
...
border-bottom: 10px solid black;
  ...
  <li class="deroulant"><a>Mon compte</a>
            ...
            <li>
                <form id='deco' name='deco' method='post' action='ChikenSatay.php'>
  ...
  <div id="plat">
          <h2><?php $recette="Chiken Satay";
                echo "$recette";?></h2></div>
  <table class="tab">
  <tr>
          <td class="maintab">Temps préparation: 21min</td>
          <td class="maintab"><form action="ChikenSatay.php#titre" method="post"><input class="boutonperso" type="submit" value=" - " name="moins">Recette pour <?php 
            $DEFAUT_PERS=4;
        ...
        <nav id="ingredients">
          ...
          <table style="display: inline-block;">
            <tr>
              ...
              <td class="etape">- <?php $qtt=round(600/$DEFAUT_PERS*$personne,1);
              echo "$qtt";?> g de blanc de poulet</td>
              <td class="imgingre"><img id="aliment" src="img\poulet.jpg" alt="poulet
              " /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(10/$DEFAUT_PERS*$personne,1);
            ...
            <tr>
              ...
              echo "$qtt";?> cuillères à café de curcuma</td>
              <td class="imgingre"><img id="aliment" src="img\curcuma.jpg" alt="curcuma" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(1/$DEFAUT_PERS*$personne,1);
              echo "$qtt";?> cuillère a café de curry</td>
            ...
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(1/$DEFAUT_PERS*$personne,1);
              echo "$qtt";?> cuillères à soupe de graine de sésame</td>
              <td class="imgingre"><img id="aliment" src="img\sesame.jpg" alt="sesame" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(1/$DEFAUT_PERS*$personne,1);
              echo "$qtt";?> cuillères à café de sucre</td>
    ...
    <article id="demarche">
      ...
      <table id="tabdemarche">
        <tr>
          ...
          <td>Coupez le poulet en petits morceaux. Confectionnez 12 petites brochettes.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Dans un grand bol, mélangez le curcuma, le lait de coco, la pâte de curry et le sucre de canne.</td>
          <td class="numdroite">2</td>
        </tr>
        <tr>
          <td class="numgauche">3</td>
          <td>Déposez les brochettes dans un grand plat. Badigeonnez-les de sauce, ainsi que les piques. Laissez mariner au minimum 12 heures.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Le jour même, égouttez les brochettes. Disposez-les côte à côte sur la grille du four. Enfournez à environ 10 cm du gril. Glissez la lèchefrite sous la grille. Versez-y un peu d’eau pour récupérer les sucs de cuisson. Allumez le gril. Faites cuire les brochettes 3 minutes, jusqu’à ce qu’elles soient croustillantes. Servez les brochettes dès la sortie du four, saupoudrées de graines de sésame et accompagnées de riz basmati.</td>
          <td class="numdroite">4</td>
        </tr>
      </table>
      <p id="source">Source : REGAL</p>
    </article>
    </section>
