...
<html lang="fr">
  <head>
    ...
    <link rel="icon" type="image/png" href="logopetitcreux.png" />
    <style> 
        header {
  ...
  <div id="plat">
          <h2><?php $recette="Maki et Sushi";
                echo "$recette";?></h2></div>
  <table class="tab">
  <tr>
          <td class="maintab">Temps préparation: 1h 20min</td>
          <td class="maintab"><form action="sushi.php#titre" method="post"><input class="boutonperso" type="submit" value=" - " name="moins">Recette pour <?php 
            $DEFAUT_PERS=2;
        ...
        <nav id="ingredients">
          ...
          <table style="display: inline-block;">
            <tr>
              ...
              echo "$qtt";?>g de riz long</td>
              <td class="imgingre"><img id="aliment" src="img\riz.jpg" alt="riz" /></td>
              <td class="titreingre"></td>
              <td class="etape">- Des feuilles de nori (algues)</td>
              <td class="imgingre"><img id="aliment" src="img\nori.jpg" alt="nori" /></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- Vinaigre de riz</td>
              <td class="imgingre"><img id="aliment" src="img\vinaigre.jpg" alt="oeuf" /></td>
              <td class="titreingre"></td>
              <td class="etape">- Sel</td>
              <td class="imgingre"><img id="aliment" src="img\sel.jpg" alt="oeuf" /></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- Garniture au choix (surimi, concombre, thon, avocat…)</td>
    ...
    <article id="demarche">
      ...
      <table id="tabdemarche">
        <tr>
          ...
          <td>Rincer le riz et l’égoutter</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Le verser dans une grande casserole et le recouvrir d’eau</td>
          <td class="numdroite">2</td>
        </tr>
        <tr>
          <td class="numgauche">3</td>
          <td>Couvrir la casserole et porter l’eau à ébullition. Laisser mijoter pendant 10min</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Laisser reposer pendant 10min</td>
          <td class="numdroite">4</td>
        </tr>
        <tr>
          <td class="numgauche">5</td>
          <td>Mélanger du vinaigre de riz avec du sucre et du sel jusqu’à dissolution du sucre.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Couper la moitié d’une feuille de nori, coupée dans le sens de la longueur, et la poser à plat sur une natte de bambou</td>
          <td class="numdroite">6</td>
        </tr>
        <tr>
          <td class="numgauche">7</td>
          <td>Etaler du riz sur la surface non brillante de la feuille en laissant une marge sur le côté</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Sur la longueur, déposer la garniture sur le riz</td>
          <td class="numdroite">8</td>
        </tr>
        <tr>
          <td class="numgauche">9</td>
          <td>En s’aidant de la natte, rouler la feuille de nori et bien refermer</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Plonger un couteau dans l’eau froide afin de couper le boudin en tronçons d’environ 1,5 cm de largeur</td>
          <td class="numdroite">10</td>
        </tr>
        <tr>
          <td class="numgauche">11</td>
          <td>Déguster avec de la sauce soja ou du wasabi.</td>
          <td></td>
          <td></td>
        </tr>
      </table>
