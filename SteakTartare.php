...
<html lang="fr">
  <head>
    ...
    <style> 
header {
background-image: url("img\\SteakTartare.jpg");
height: 450px;
...
border-bottom: 10px solid black;
  ...
  <li class="deroulant"><a>Mon compte</a>
            ...
            <li>
                <form id='deco' name='deco' method='post' action='SteakTartare.php'>
  ...
  <div id="plat">
          <h2><?php $recette="Steak Tartare";
                echo "$recette";?></h2></div>
  <table class="tab">
  <tr>
          <td class="maintab">Temps préparation: 20min</td>
          <td class="maintab"><form action="SteakTartare.php#titre" method="post"><input class="boutonperso" type="submit" value=" - " name="moins">Recette pour <?php 
            $DEFAUT_PERS=2;
        ...
        <nav id="ingredients">
          ...
          <table style="display: inline-block;">
            <tr>
              ...
              echo "$qtt";?>g de boeuf frais</td>
              <td class="imgingre"><img id="aliment" src="img\boeuf.jpg" alt="boeuf" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(1/$DEFAUT_PERS*$personne);
              echo "$qtt";?> jaune d'oeuf</td>
              <td class="imgingre"><img id="aliment" src="img\jauneoeuf.jpg" alt="jauneoeuf" /></td>
			  <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=0.5/$DEFAUT_PERS*$personne;
              echo "$qtt";?>cuillère a café de moutarde de Dijon</td>
              <td class="imgingre"><img id="aliment" src="img\moutarde.jpg" alt="moutarde" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=0.5/$DEFAUT_PERS*$personne;
              echo "$qtt";?> oignon haché</td>
              <td class="imgingre"><img id="aliment" src="img\onion.jpg" alt="oignon" /></td>
			  <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=0.5/$DEFAUT_PERS*$personne;
              echo "$qtt";?>cuillère à soupe de câpres</td>
              <td class="imgingre"><img id="aliment" src="img\capres.png" alt="capres" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=0.5/$DEFAUT_PERS*$personne;
              echo "$qtt";?> cuillère de ketchup</td>
              <td class="imgingre"><img id="aliment" src="img\ketchup.jpg" alt="ketchup" /></td>
			  <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- Poivre a souhait</td>
              <td class="imgingre"><img id="aliment" src="img\poivre.jpg" alt="poivre" /></td>
              <td class="titreingre"></td>
              <td class="etape">- Quelques gouttes de Tabasco</td>
              <td class="imgingre"><img id="aliment" src="img\Sauce-pimentee.jpg" alt="Tabasco" /></td>
			  <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              ...
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(1/$DEFAUT_PERS*$personne);
              echo "$qtt";?> branche de persil plat haché</td>
              <td class="imgingre"><img id="aliment" src="img\persil.jpg" alt="ketchup" /></td>
			  <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
    ...
    <article id="demarche">
      ...
      <table id="tabdemarche">
        <tr>
          ...
          <td>Couper la viande au couteau</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Dans un bol, mélanger le jaune d’œuf, la moutarde de Dijon, l'oignon, les câpres, la Worcestershire sauce, le ketchup, le tabasco, le sel et le poivre. Ajouter l'huile d'olive en remuant avec le fouet.</td>
          <td class="numdroite">2</td>
        </tr>
        <tr>
          <td class="numgauche">3</td>
          <td>Ajouter la viande à la sauce ainsi que le persil. Rectifier l'assaisonnement.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Réfrigérer ou servir immédiatement.</td>
