...
<html lang="fr">
  ...
  header {
  background-image: url("img\\paindeviande.jpg");
  height: 450px;
  ...
  <li class="deroulant"><a>Mon compte</a>
            ...
            <li>
                <form id='deco' name='deco' method='post' action='paindeviande.php'>
  ...
  <div id="plat">
          <h2><?php $recette="Pain de viande";
                echo "$recette";?></h2></div>
  <table class="tab">
  <tr>
          <td class="maintab">Temps préparation: 10min</td>
          <td class="maintab"><form action="paindeviande.php#titre" method="post"><input class="boutonperso" type="submit" value=" - " name="moins">Recette pour <?php 
            $DEFAUT_PERS=4;
        ...
        <nav id="ingredients">
          ...
          <table style="display: inline-block;">
            ...
            <tr>
              ...
              echo "$qtt";?> cuillère à soupe de ketchup épicé</td>
    ...
    <article id="demarche">
      ...
      <table id="tabdemarche">
        <tr>
          ...
          <td>Préchauffez votre four à 175°C.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Dans un robot, placez le persil et l'oignon.</td>
          <td class="numdroite">2</td>
        </tr>
        <tr>
          <td class="numgauche">3</td>
          <td>Hachez quelque secondes, puis ajoutez le pain coupé en petits dés et mixez.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Ajouter la viande, le ketchup, l'oeuf et la muscade.</td>
          <td class="numdroite">4</td>
        </tr>
        <tr>
          <td class="numgauche">5</td>
          <td>Salez, poivrez, puis mixez à nouveau.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Dans un plat allant au four, placez le hachis en lui donnant la forme d'une boule de pain. </td>
          <td class="numdroite">6</td>
        </tr>
        <tr>
          <td class="numgauche">7</td>
          <td>Enfournez 45 minutes.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Accompagnez de légumes et servez bien chaud. </td>
