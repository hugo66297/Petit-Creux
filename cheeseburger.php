...
<html lang="fr">
  ...
  header {
  background-image: url("img\\cheeseburger.jpg");
  height: 450px;
  ...
  <div id="plat">
          <h2><?php $recette="Cheeseburger";
                echo "$recette";?></h2></div>
  <table class="tab">
  <tr>
          <td class="maintab">Temps préparation: 10min</td>
          <td class="maintab"><form action="cheeseburger.php#titre" method="post"><input class="boutonperso" type="submit" value=" - " name="moins">Recette pour <?php 
            $DEFAUT_PERS=4;
        ...
        <nav id="ingredients">
          ...
          <table style="display: inline-block;">
            <tr>
              ...
              echo "$qtt";?> steak haché</td>
              <td class="imgingre"><img id="aliment" src="img\viandehachee.jpg" alt="steakhache" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(4/$DEFAUT_PERS*$personne);
              echo "$qtt";?> fromage en tranche</td>
              <td class="imgingre"><img id="aliment" src="img\fromageentranche.jpg" alt="fromageentranche" /></td>
              <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(4/$DEFAUT_PERS*$personne);
              echo "$qtt";?> pains à hamburger</td>
              <td class="imgingre"><img id="aliment" src="img\painhamburger.jpg" alt="painhamburger" /></td>
              <td class="titreingre"></td>
              <td class="etape">- <?php $qtt=round(4/$DEFAUT_PERS*$personne);
              echo "$qtt";?> feuilles de laitue</td>
              <td class="imgingre"><img id="aliment" src="img\feuillelaitue.jpg" alt="feuillelaitue" /></td>
              <td class="titreingre"></td>
            </tr>
            <tr>
              <td class="titreingre"></td>
    ...
    <article id="demarche">
      ...
      <table id="tabdemarche">
        <tr>
          ...
          <td>Faites cuire les steaks hachés 4 minutes dans une poêle chaude avec un filet d'huile d'olive. </td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Retournez les steaks et continuez la cuisson 2 minutes en assaisonnant à votre convenance, sel et poivre</td>
          <td class="numdroite">2</td>
        </tr>
        <tr>
          <td class="numgauche">3</td>
          <td>Posez les tranches de fromage sur chaque steak et couvrez, puis poursuivez la cuisson encore 2 minutes à feu doux afin que le fromage fonde un peu.</td>
          <td></td>
          <td></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td>Disposez les steaks dans les pains à hamburgers, puis garnissez de rondelles de tomate préalablement coupées, de feuilles de laitue et d'oignon émincé.</td>
